...
const Contact = () => {
  return (
    <div id="contact" className="w-full h-full ">
      <div className="max-w-[1240px] m-auto px-2  pt-24 pb-10 w-full ">
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="w-full h-full col-span-3 p-4 shadow-xl lg:col-span-2 shadow-gray-400 rounded-xl">
            <div className="h-full lg:p-4 ">
              ...
              <div>
                <h2 className="py-2">Gabriel Dumaug</h2>
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4">
                  ...
                  <a
                    href="https://www.gabrieldumaug.com/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <div className="p-6 duration-300 ease-in rounded-full shadow-lg cursor-pointer shadow-gray-400 hover:scale-110">
          ...
          {/* right  NOTE fix later put email */}
